                ...
                <div class="breadcrumbs-top">
                    ...
                    <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                            ...
                            <li class="breadcrumb-item active">Create Gift Days
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Gift Days Create</h4>
                            </div>
                            <div class="card-body">
                                <form id="jquery-val-form" method="post" action="{{ route('admin.gift_days.store') }}" >
                                    @csrf
                                    @if (count($errors) > 0)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" id="auto_generate" class="form-control" placeholder="Enter Code" aria-describedby="auto_generate">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" 
                                            name="price" placeholder="Enter Price" value="{{old('price')}}" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"/>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="basic-default-name">No of days</label>
                                        <input type="text" class="form-control" 
                                            name="days" placeholder="Enter No of days" value="{{old('days')}}" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control w-25" name="commession_type" id="button-addon1">
                                            ...
                                            <input type="text" class="form-control w-75" name="commession" placeholder="Enter Commession" aria-label="Example text with button addon" aria-describedby="button-addon1" value="{{old('commession')}}" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="basic-default-name">Description</label>
                                           <textarea id="my-textarea" class="form-control" name="description" placeholder="Enter Description" rows="3">{{old('description')}}</textarea>
                                    </div>

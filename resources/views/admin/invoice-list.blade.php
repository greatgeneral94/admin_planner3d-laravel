...
@section('css')
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors/css/tables/datatable/dataTables.checkboxes.css') }}">
        ...
        <div class="content-body">
            ...
            <section class="invoice-list-wrapper">
                ...
                <div class="invoice-create-btn mb-1">
                    <a href="{{ url('/' . $page='invoice-add') }}" class="btn btn-primary glow invoice-create" role="button" aria-pressed="true">Create
                        Invoice</a>
                </div>
                    ...
                    <table class="table invoice-data-table dt-responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00956</a>
                                </td>
                                ...
                                <td>
                                    <div class="invoice-action">
                                        <a href="{{ url('/' . $page='invoice') }}" class="invoice-action-view mr-1">
                                            <i class="bx bx-show-alt"></i>
                                        </a>
                                        <a href="{{ url('/' . $page='invoice-edit') }}" class="invoice-action-edit cursor-pointer">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00349</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00853</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00452</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00123</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00153</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00788</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00326</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00759</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00999</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{ url('/' . $page='invoice') }}">INV-00223</a>
                                </td>
                                <td><span class="invoice-amount">$459.30</span></td>

@extends('master')
@section('css')
<link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors/css/calendars/tui-time-picker.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors/css/calendars/tui-date-picker.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors/css/calendars/tui-calendar.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('app-assets/css/plugins/calendars/app-calendar.css') }}">
@endsection
@section('type')
...
@section('js')
   ...
   <script src="{{ asset('app-assets/vendors/js/calendar/tui-code-snippet.min.js') }}"></script>
   <script src="{{ asset('app-assets/vendors/js/calendar/tui-dom.js') }}"></script>
   <script src="{{ asset('app-assets/vendors/js/calendar/tui-time-picker.min.js') }}"></script>
   <script src="{{ asset('app-assets/vendors/js/calendar/tui-date-picker.min.js') }}"></script>
   <script src="{{ asset('app-assets/vendors/js/extensions/moment.min.js') }}"></script>
   <script src="{{ asset('app-assets/vendors/js/calendar/chance.min.js') }}"></script>
   <script src="{{ asset('app-assets/vendors/js/calendar/tui-calendar.min.js') }}"></script>
   <!-- END: Page Vendor JS-->



   <!-- BEGIN: Page JS-->
   <script src="{{ asset('app-assets/js/scripts/extensions/calendar/calendars-data.js') }}"></script>
   <script src="{{ asset('app-assets/js/scripts/extensions/calendar/schedules.js') }}"></script>
   <script src="{{ asset('app-assets/js/scripts/extensions/calendar/app-calendar.js') }}"></script>
   <!-- END: Page JS-->
@endsection
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-inline text-center mt-1 mb-0">
                                    <li class="mr-2"><span
                                            class="bullet bullet-xs bullet-primary mr-50"></span>Target</li>
                                ...
                                <div class="col-md-8 col-12 order-summary border-right pr-md-0">
                                    <div class="card mb-0">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <button type="button"
                                                    class="btn btn-sm btn-light-primary mr-1">Week</button>
                                                <button type="button"
                                                    class="btn btn-sm btn-primary glow">Month</button>
                                            </div>
                                        </div>
                                ...
                                <table id="table-marketing-campaigns"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="py-1 line-ellipsis">
                                                <img class="rounded-circle mr-1"
                                                    src="app-assets/images/icon/puma.png" alt="card" height="24"
                                                    width="24">Puma Shoes
                                            </td>
                                            <td class="py-1">
                                                <i
                                        ...
                                        <tr>
                                            <td class="py-1 line-ellipsis">
                                                <img class="rounded-circle mr-1"
                                                    src="app-assets/images/icon/nike.png" alt="card" height="24"
                                                    width="24">Nike Air Jordan
                                            </td>
                                            <td class="py-1">
                                                <i
                                                    class="bx bx-trending-up text-success align-middle mr-50"></i><span>70.3%</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="py-1 line-ellipsis">
                                                <img class="rounded-circle mr-1"
                                                    src="app-assets/images/icon/one-plus.png" alt="card" height="24"
                                        ...
                                        <tr>
                                            <td class="py-1 line-ellipsis">
                                                <img class="rounded-circle mr-1"
                                                    src="app-assets/images/icon/google.png" alt="card" height="24"

            ...
            <section class="users-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form-validate" action="{{ route('b1.profile.update', ['id'=>$user->id]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            <label>Country</label>
                                            <select class="selectpicker countrypicker form-control @error('country') is-invalid @enderror" name="country" data-live-search="true" data-default="{{$user->country}}"></select>
                                        </div>
                                    </div>
                                </div>

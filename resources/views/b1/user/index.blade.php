                ...
                <div class="users-list-table">
                    <div class="card">
                        <div class="col-12 col-sm-6 col-lg-3 my-3 d-flex align-items-center">
                            <a href="{{ route('b1.user.create') }}" class="btn btn-primary btn-block glow users-list-clear mb-0">Create C1</a>
                        </div>
                        <div class="card-body">
                            <!-- datatable start -->
                                ...
                                <table id="users-list-datatable" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('b1.user.edit', ['id'=>$item->id]) }}"><i class="bx bx-edit-alt"></i></a>
                                                <a href="{{ route('b1.user.delete', ['id'=>$item->id]) }}"><i class="bx bx-trash-alt"></i></a>
                                            </td>

  ...
  $.app.menu = {
    ...
    expand: function () {
      if (this.expanded === false) {
        $("#adminheadsvg").css("hight", 40);
        $("#adminheadsvg").css("width", 150);
        if ($body.data("menu") == "vertical-menu-modern") {
          $(".modern-nav-toggle")
            .find(".toggle-icon")
            .removeClass("bx bx-arrow-to-right")
            .addClass("bx bx-arrow-to-left");
        }
        this.transit(
          function () {
    ...
    collapse: function (defMenu) {
      if (this.collapsed === false) {
        $("#adminheadsvg").css("hight", 10);
        $("#adminheadsvg").css("width", 50);
        if ($body.data("menu") == "vertical-menu-modern") {
          $(".modern-nav-toggle")
            .find(".toggle-icon")
            .removeClass("bx bx-arrow-to-left")
            .addClass("bx bx-arrow-to-right");
        }
        this.transit(
          function () {

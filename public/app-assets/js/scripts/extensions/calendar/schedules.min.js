...
function generateTime(e, a, n) {
    ...
    e.isAllday = chance.bool({
        ...
        min: 0,
        max: 1
    })], e.category === SCHEDULE_CATEGORY[1] && (e.dueDateClass = "morning")) : e.category = "time", o.add(chance.integer({
        min: 0,
        max: t
    }), "days"), o.hours(chance.integer({
        min: 0,
        max: 23
    })), o.minutes(chance.bool() ? 0 : 30), e.start = o.toDate(), i = moment(o), e.isAllday && i.add(chance.integer({
        min: 0,
        max: 3
...
function generateNames() {
    for (var e = [], a = 0, n = chance.integer({
            min: 1,
            max: 10
        }); a < n; a += 1) e.push(chance.name({
        nationality: "en"
    }));
    return e
}
...
function generateRandomSchedule(e, a, n) {
    ...
    if (o.id = chance.guid(), o.calendarId = e.id, o.title = chance.name({
            nationalty: "en"
        }), o.body = chance.bool({
            likelihood: 20
        }) ? chance.sentence({
            words: 10
        }) : "", o.isReadOnly = chance.bool({
            likelihood: 20
        }), generateTime(o, a, n), o.isPrivate = chance.bool({
            likelihood: 10
        }), o.location = chance.address(), o.attendees = chance.bool({
            likelihood: 70
        }) ? generateNames() : [], o.recurrenceRule = chance.bool({
            likelihood: 20
        }) ? "repeated events" : "", o.color = e.color, o.bgColor = e.bgColor, o.dragBgColor = e.dragBgColor, o.borderColor = e.borderColor, "milestone" === o.category && (o.color = o.bgColor, o.bgColor = "transparent", o.dragBgColor = "transparent", o.borderColor = "transparent"), o.raw.memo = chance.sentence(), o.raw.creator.name = chance.name(), o.raw.creator.avatar = chance.avatar(), o.raw.creator.company = chance.company(), o.raw.creator.email = chance.email(), o.raw.creator.phone = chance.phone(), chance.bool({
            likelihood: 20
        })) {
        var i = chance.minute();
